...
class Ui_MainWindowUi(object):
    def setupUi(self, MainWindowUi):
        ...
        self.multiGenre = FilterView(self.splitter_5)
        self.multiGenre.setObjectName(u"multiGenre")
        self.splitter_5.addWidget(self.multiGenre)
        self.multiArtist = FilterView(self.splitter_5)
        self.multiArtist.setObjectName(u"multiArtist")
        self.splitter_5.addWidget(self.multiArtist)
        self.multiAlbum = FilterView(self.splitter_5)
        self.multiAlbum.setObjectName(u"multiAlbum")
        self.splitter_5.addWidget(self.multiAlbum)
        ...
        self.verticalLayout_10.addWidget(self.splitter_6)
